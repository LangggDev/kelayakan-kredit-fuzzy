...
<div class="card overflow-hidden">
    <div class="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
        ...
        <a href="{{ route('marketing.analisis.index') }}" class="text-xs font-semibold hover:underline" style="color:#1a2e5a">Lihat Semua →</a>
    </div>
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead>
                <tr class="border-b border-slate-100" style="background:#f4f6fb">
                    <th class="text-left px-5 py-3 text-xs font-semibold text-slate-500 uppercase">Nasabah</th>
