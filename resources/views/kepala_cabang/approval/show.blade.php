...
@section('content')
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <div class="w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0"
                    ...
                    <i
                        class="fa-solid {{ $approval->keputusan === 'Layak' ? 'fa-circle-check text-green-400' : 'fa-circle-xmark text-red-400' }} text-2xl"></i>
                </div>
                <div>
                    ...
                    <p class="text-white/70 text-sm mt-0.5">
                        Skor: <span
                            class="font-mono font-bold text-white">{{ number_format($approval->nilai_defuzzifikasi, 2) }}</span>
            ...
            <div class="flex-shrink-0">
                <span
                    class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold border {{ $approval->status_color }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div class="card p-5">
            ...
            <dl class="space-y-2">
                ...
                <div class="flex justify-between py-1.5">
                    ...
                    <dd class="text-xs font-semibold text-slate-800">
        ...
        <div class="card p-5">
            ...
            <dl class="space-y-2">
                <div class="flex justify-between py-1.5 border-b border-slate-50">
                    <dt class="text-xs text-slate-500 flex items-center gap-1.5"><span
                            class="w-4 h-4 rounded text-white text-xs font-bold flex items-center justify-center"
                            style="background:#2563eb;font-size:9px">C1</span>Skor Kredit</dt>
                    <dd class="text-xs font-semibold text-slate-800">{{ number_format($approval->skor_kredit, 0) }} / 100
                    </dd>
                </div>
                <div class="flex justify-between py-1.5 border-b border-slate-50">
                    <dt class="text-xs text-slate-500 flex items-center gap-1.5"><span
                            class="w-4 h-4 rounded text-white text-xs font-bold flex items-center justify-center"
                            style="background:#16a34a;font-size:9px">C2</span>Penghasilan/Bln</dt>
                    <dd class="text-xs font-semibold text-slate-800">Rp
                        {{ number_format($approval->penghasilan, 0, ',', '.') }}</dd>
                </div>
                <div class="flex justify-between py-1.5 border-b border-slate-50">
                ...
                <div class="flex justify-between py-1.5 border-b border-slate-50">
                    ...
                    <dd
                        class="text-xs font-semibold {{ $approval->rasio_cicilan <= 30 ? 'text-green-600' : ($approval->rasio_cicilan <= 50 ? 'text-amber-600' : 'text-red-600') }}">
                ...
                <div class="flex justify-between py-1.5 border-b border-slate-50">
                    <dt class="text-xs text-slate-500 flex items-center gap-1.5"><span
                            class="w-4 h-4 rounded text-white text-xs font-bold flex items-center justify-center"
                            style="background:#d97706;font-size:9px">C3</span>Aset Bersih</dt>
                    <dd class="text-xs font-semibold">Rp {{ number_format($approval->aset_bersih, 0, ',', '.') }}</dd>
                </div>
                <div class="flex justify-between py-1.5 border-b border-slate-50">
                    <dt class="text-xs text-slate-500 flex items-center gap-1.5"><span
                            class="w-4 h-4 rounded text-white text-xs font-bold flex items-center justify-center"
                            style="background:#9333ea;font-size:9px">C4</span>Nilai Agunan</dt>
                    <dd class="text-xs font-semibold">Rp {{ number_format($approval->nilai_agunan, 0, ',', '.') }}</dd>
                </div>
                <div class="flex justify-between py-1.5">
                    <dt class="text-xs text-slate-500 flex items-center gap-1.5"><span
                            class="w-4 h-4 rounded text-white text-xs font-bold flex items-center justify-center"
                            style="background:#e11d48;font-size:9px">C5</span>Kondisi Ekonomi</dt>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">
                        Analisis ini tercatat otomatis sebagai <strong>Tidak Layak</strong>. Tidak memerlukan persetujuan Kepala
                        Cabang.
                    </p>
                </div>
            </div>
