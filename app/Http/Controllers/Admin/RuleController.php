...
class RuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'capacity'    => 'required|in:tinggi,sedang,rendah,any',
            'capital'     => 'required|in:besar,sedang,kecil,any',
            'collateral'  => 'required|in:tinggi,sedang,rendah,any',
            'condition'   => 'required|in:baik,cukup,buruk,any',
