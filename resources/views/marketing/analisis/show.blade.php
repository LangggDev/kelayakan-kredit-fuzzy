...
@section('content')
    ...
    {{-- Read only notice --}}
    <div class="flex items-center gap-2 px-4 py-3 rounded-xl text-xs mb-6"
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-white/70 text-sm mt-1">Skor: <span
                            class="text-white font-semibold font-mono">{{ number_format($analisis->nilai_defuzzifikasi ?? 0, 4) }}</span>
                        &mdash; {{ number_format($analisis->persentase_kelayakan, 2) }}%</p>
                </div>
            </div>
            <div class="flex items-center gap-2 flex-shrink-0">
                <span
                    class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-bold badge-disetujui border text-white"
                    style="border-color: rgba(255,255,255,0.3); background: rgba(255,255,255,0.1)">
    ...
    @if($analisis->catatan_approval)
        <div class="card p-4 mb-6" style="background:#f0fdf4; border-color:#bbf7d0; border-width:1px">
