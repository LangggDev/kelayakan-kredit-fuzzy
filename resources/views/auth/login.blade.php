        ...
        <div class="relative">
            ...
            <input
                ...
                class="w-full pl-10 pr-4 py-2.5 border rounded-xl text-sm bg-slate-50 focus:bg-white transition-colors
                    {{ $errors->has('nik') ? 'border-red-300 bg-red-50' : 'border-slate-200' }}"
                required
                autofocus
...
<div class="mt-5 pt-5 border-t border-slate-100">
    ...
    <div class="grid grid-cols-2 gap-2">
        <button onclick="fillLogin('ADM001','admin123')"
            ...
            <div class="flex items-center gap-2 mb-1">
                <span class="w-5 h-5 rounded flex items-center justify-center text-white text-xs font-bold" style="background:#1a2e5a">A</span>
                <span class="text-xs font-bold" style="color:#1a2e5a">Administrator</span>
            </div>
            <div class="text-xs text-slate-500">NIK: <span class="font-mono font-semibold">ADM001</span></div>
            <div class="text-xs text-slate-400">Pass: admin123</div>
        </button>

        <button onclick="fillLogin('KA001','analis123')"
            class="p-2.5 rounded-xl text-left hover:opacity-90 transition-opacity border"
            style="background:#dbeafe; border-color:#bfdbfe">
            <div class="flex items-center gap-2 mb-1">
                <span class="w-5 h-5 rounded flex items-center justify-center text-white text-xs font-bold" style="background:#2563eb">KA</span>
                <span class="text-xs font-bold text-blue-700">Kredit Analis</span>
            </div>
            <div class="text-xs text-slate-500">NIK: <span class="font-mono font-semibold">KA001</span></div>
            <div class="text-xs text-slate-400">Pass: analis123</div>
        </button>

        <button onclick="fillLogin('KC001','kc12345678')"
            class="p-2.5 rounded-xl text-left hover:opacity-90 transition-opacity border"
            style="background:#fef9ee; border-color:#fde68a">
            <div class="flex items-center gap-2 mb-1">
                <span class="w-5 h-5 rounded flex items-center justify-center text-white text-xs font-bold" style="background:#d97706">KC</span>
                <span class="text-xs font-bold text-amber-700">Kepala Cabang</span>
            </div>
            <div class="text-xs text-slate-500">NIK: <span class="font-mono font-semibold">KC001</span></div>
            <div class="text-xs text-slate-400">Pass: kc12345678</div>
        </button>

        <button onclick="fillLogin('MKT001','mkt12345678')"
            class="p-2.5 rounded-xl text-left hover:opacity-90 transition-opacity border"
            style="background:#f0fdf4; border-color:#bbf7d0">
            <div class="flex items-center gap-2 mb-1">
                <span class="w-5 h-5 rounded flex items-center justify-center text-white text-xs font-bold" style="background:#16a34a">MK</span>
                <span class="text-xs font-bold text-green-700">Marketing</span>
            </div>
            <div class="text-xs text-slate-500">NIK: <span class="font-mono font-semibold">MKT001</span></div>
