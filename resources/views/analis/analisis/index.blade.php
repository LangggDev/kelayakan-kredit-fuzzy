    ...
    <div class="card p-4">
        <form action="{{ route('analis.analisis.index') }}" method="GET" class="flex flex-col sm:flex-row gap-3 flex-wrap">
            <div class="relative flex-1 min-w-48">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama atau NIK debitur..."
                ...
                <tbody class="divide-y divide-slate-50">
                    @forelse($riwayat as $item)
                        <tr class="table-row">
                            ...
                            <td class="px-4 py-4 text-center">
                                <span
                                    class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold border {{ $item->status_color }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-5 py-14 text-center">
                                ...
                                <a href="{{ route('analis.analisis.create') }}"
                                    class="text-sm font-semibold hover:underline mt-1 inline-block" style="color:#1a2e5a">
